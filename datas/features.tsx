const _features_d: { [key: string]: any } = {
  basic: {
    description: [
...
const _features_d_v: { [key: string]: any } = {
  basic: {
    description: [
        'A One-Star-class vehicle is made available to you.',
        'Access to 5 hours of work per day upon your initial login.These working hours are flexible and can be accumulated.',
        'Real-time notifications of ride opportunities.',
       
    ],
    prix: 2500,
    content: "Essential offer to kickstart your driver business. Benefit from platform access and basic customer support."
  },
  standart: {
    description: [
        'All the benefits of the basic package are included.',
  ...
  premium: {
    description: [
        'All the benefits of both the basic and standard packages are included.',
        'Complimentary VIP ride offered if the vehicle meets the criteria.',
        'Unlimited and flexible work hours on the platform without any restrictions or limitations.',
        "Priority in processing ride requests."
