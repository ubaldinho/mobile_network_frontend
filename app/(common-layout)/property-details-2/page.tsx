...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[var(--bg-2)] mt-10 lg:mt-14">
        <div className="container">
          <div className="grid grid-cols-12 gap-4 lg:gap-6 px-3">
            <div className="col-span-12 xl:col-span-8">
              <div className="mb-10 lg:mb-14">
                <div className="bg-white rounded-2xl p-2 lg:py-8 lg:px-5">
                  <div className="p-3 sm:p-4 lg:p-6 bg-[var(--bg-1)] rounded-2xl border  mb-6 md:mb-10">
                  ...
                  <div className="p-3 sm:p-4 lg:p-6 bg-[var(--bg-1)] rounded-2xl border border-neutral-40 mb-6 md:mb-10">
