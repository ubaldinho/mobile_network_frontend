            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-4 m-3">
              <div className="bg-white p-6">
                <div className="text-center">
                  ...
                  <h1 className="h2 clr-primary-400 mb-2"> 2500 FCFA </h1><p className="mb-0"> Per month </p>
                  <p className="m-1" >
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-4 m-3">
              <div className="bg-primary p-6 ">
                <div className="text-center">
                  ...
                  <div className="border border-dashed mt-8 mb-4"></div>
                  <h1 className="h2 text-[var(--tertiary)] mb-2"> 5000FCFA </h1>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-4 m-3">
              <div className="bg-[var(--dark)] p-6 text-yellow-500" >
                <div className="text-center">
                  ...
                  <div className="border border-dashed mt-8 mb-4"></div>
                  <h1 className="h2 text-[var(--tertiary)] mb-2"> 10000 FCFA </h1>
                  ...
                  <Link href="#" className="btn-outline  font-semibold text-[var(--tertiary)]">
                    Choose Plan
                  </Link>
                </div>
              </div>
