...
const page = () => {
  ...
  const subscription_date = '21-03-2002'
  const tax = 4
  const subtotal = 3000
  const service_charge = 10
  const promo_discount = 20
  const renawal_date = '21-04-2024'
  const total_payable_amount = 2500
  const  plan_name : string  = "default"
  const all_features = [
              ...
              <div className="bg-white rounded-2xl p-3 sm:p-4 lg:p-6 mb-6">
                ...
                <div className="grid grid-cols-12 gap-4 md:gap-3 mb-8">
                  <div className="col-span-12 md:col-span-12">
                    <h4 className="mb-3 text-2xl font-semibold"> Your plan Name : ${plan_name} </h4>
                    <div className="border border-dashed my-6"></div>

                  </div>

                  {all_features.map((valeur: string, index: number) => (
            ...
            <div className="bg-white rounded-2xl p-3 mb-6 sm:p-4 lg:p-6 border">
              ...
              <li className="flex items-center justify-between flex-wrap">
                ...
                <li className="flex items-center justify-between flex-wrap">
                  ...
                  <p className="mb-0 font-medium">{renawal_date}</p>
                </li>
                <div className="border border-dashed my-6"></div>
              ...
              <div className="grid grid-cols-12 gap-4 lg:gap-6">
                { <><div className="col-span-12">
                  ...
                  <input
                    ...
                    id="card-number" />
                </div><div className="col-span-12 md:col-span-6">
                    <label
                      htmlFor="expiry-date"
                      className="text-xl font-medium block mb-3"
                    >
